...
<table style="width: 90%">
	...
	if(hCart.size() == 0){
	%>
	<tr><td>주문 내역이 없어용~</td></tr>	
	<%
	}else {
		Enumeration enu = hCart.keys();   //Map collection 읽어 처리하기
	...
	<tr style="text-align: center;">
		...
		<td><%=subTotal %></td>
		<td>
			<input type="text" name="quantity" style="text-align: center;" size="5" value="<%=quantity %>">
		</td>
		<td>
			<input style="background-color: beige" type="button" value="수정" onclick="cartUpdate(this.form)"> /
			<input style="background-color: red" type="button" value="삭제" onclick="cartDelete(this.form)"> 
		</td>
		<td>
	...
	<tr>
		...
		<a href="orderproc.jsp">[ 주 문 하 기 ]</a>
		</b>		
		</td>
	</tr>
	<%
